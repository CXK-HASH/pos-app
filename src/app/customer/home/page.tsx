    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="sticky top-14 z-40 bg-white/60 backdrop-blur-md border-b border-slate-100">
        <div className="max-w-5xl mx-auto px-6 py-3 flex items-center gap-3">
          {/* 地址切换 */}
          <button
            onClick={() => { setAddressInput(address); setShowAddressModal(true) }}
      ...
      {showAddressModal && (
        ...
        >
          ...
          >
            <h3 className="text-lg font-bold text-slate-800 mb-1">📍 选择配送地址</h3>
            <p className="text-xs text-slate-400 mb-4">请输入新的配送地址</p>
            <input
              type="text"
              value={addressInput}
              ...
              placeholder="请输入地址..."
              className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-700 placeholder-slate-400 focus:outline-none focus:border-orange-500 transition-all"
              autoFocus
            />
            <div className="flex gap-3 mt-4">
              ...
              <button
                ...
                className="flex-1 py-2.5 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-xl text-sm font-bold hover:shadow-md transition-all"
              >
                确定
              </button>
            </div>
