  ...
  return (
    <div className="min-h-screen bg-[#0B0F19] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="bg-slate-900/60 backdrop-blur-lg rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.6)] border border-slate-800 p-6 space-y-4">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-2.5 bg-slate-800/50 border border-slate-700 rounded-xl text-sm text-white placeholder-slate-500 focus:outline-none focus:border-orange-500 focus:bg-slate-800 transition-all"
            />
          </div>
          ...
          {isSignUp && (
            <div className="mb-1">
              <label className="block text-sm font-medium text-slate-400 mb-2">选择您的身份</label>
          ...
          <div className="pt-2 border-t border-slate-800 mt-2">
            <p className="text-xs text-slate-500 text-center leading-relaxed">
              💡 测试账号：<br />
              消费者 <span className="text-slate-400">test1234@qq.com</span> / <span className="text-slate-400">123456</span>
            </p>
          </div>
        </form>
      </div>
